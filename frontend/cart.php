...
<html lang="en">
  <head>
    ...
    <title>Cart Page - DVDTrendy</title>
                    ...
                    <ul class="products">
                      <li class="product">
                        <a href="single-product.php">
                          ...
                          <h3>The Mechanic</h3>
                          <span class="price"
                            ><span class="amount">Rp.200.000</span></span
                          >
                        </a>
                      ...
                      <li class="product">
                        <a href="single-product.php">
                          ...
                          <span class="price"
                            ><span class="amount">Rp.69.000</span></span
                          >
                        </a>
                    ...
                    <table cellspacing="0">
                      <tbody>
                        <tr class="cart-subtotal">
                          <th>Cart Subtotal</th>
                          <td><span class="amount">Rp.250.000</span></td>
                        </tr>
                        ...
                        <tr class="order-total">
                          ...
                          <td>
                            <strong
                              ><span class="amount">Rp.250.000</span></strong
                            >
                          </td>
                        </tr>
                      </tbody>
